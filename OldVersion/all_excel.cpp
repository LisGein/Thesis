...
long Workbooks::GetCount()
{
	...
	COleVariant s(result);
	s.ChangeType(VT_I4);
	return s.lVal;
}

//VARIANT Workbooks::GetCount() {	VARIANT result;
//	GetProperty(0x76, VT_VARIANT, (void*)&result);	return result;}
...
void _Worksheet::Select()
{
	static BYTE parms[] =
		VTS_VARIANT;
	InvokeHelper(0xeb, DISPATCH_METHOD, VT_EMPTY, NULL, NULL, NULL);
}
...
//	BYTE parmsd[] = VTS_DATE;
//	if (newValue.vt==VT_DATE)
//		InvokeHelper(0x56c, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parmsd,
//				&newValue);
//	else
